...
declare type Options<State, Update extends AnyFunction> = {
    defaultState?: State;
 ...
 */
declare type DeprecatedOption = boolean;
export declare const createContainer: <State, Update extends AnyFunction, Props>(useValue: (props: Props) => readonly [State, Update], options?: boolean | Options<State, Update> | undefined) => {
